...
router.get("/", authenticate, authorizeRoles("admin", "manager", "kitchen"), inventoryController.getInventory);
router.get("/metadata", authenticate, authorizeRoles("admin", "manager", "kitchen"), inventoryController.getMetadata);
...
router.get("/item/:id", authenticate, authorizeRoles("admin", "manager", "kitchen"), inventoryController.getInventoryItem);
...
router.get("/low-stock", authenticate, authorizeRoles("admin", "manager", "kitchen"), inventoryController.getLowStockItems);
